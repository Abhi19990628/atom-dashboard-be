...
urlpatterns = [
    ...
    path(
        "dashboard-tables/",
        views.get_assignment_idle_data,
        name="get_assignment_idle_data",
    ),
    ...
    path(
        "assignment/save/",
        views.save_operator_assignment,
        name="save_operator_assignment",
    ),
    ...
    path(
        ...
        views.get_auto_fill_data,
        name="get_auto_fill_data",
    ),
    path(
        "ideal-reports/pending/",
        views.get_pending_ideal_reports,
        name="get_pending_ideal_reports",
    ),
    path(
        "ideal-reports/<int:event_id>/submit/",
        views.submit_ideal_report,
        name="submit_ideal_report",
    ),
    path("idle-reports/", views.create_idle_report, name="create_idle_report"),
    # Production APIs
    path(
        "machine-production/",
        views.machine_production_data,
        name="machine_production_data",
    ),
    path(
        "production-line-status/",
        views.production_line_status_data,
        name="production_line_status_data",
    ),
    ...
    # History APIs
    path(
        "plant1-machine-history/",
        views.get_plant1_machine_history,
        name="plant1_machine_history",
    ),
    ...
    # Data Saving
    path(
        "save-hourly-snapshot/", views.save_hourly_snapshot, name="save_hourly_snapshot"
    ),
    path(
        "machine-changes/", views.get_machine_changes_from_db, name="machine_changes_db"
    ),
    ...
    path(
        "plant2/hourly-idle/summary/",
        views.plant2_hourly_idle_summary,
        name="plant2-hourly-idle-summary",
    ),
    ...
    path(
        "qa-notifications/<str:username>/",
        GetQANotificationsView.as_view(),
        name="api_get_qa_notifications",
    ),
