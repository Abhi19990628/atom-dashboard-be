    ...
    def post(self, request):
        try:
            ...
            report, created = InspectionReport.objects.get_or_create(
                ...
                defaults={
                    'part_number': master.get('part_number', 'N/A'),'model_name': master.get('model_name', ''), 'plant_location': master.get('plant_location', 'PLANT 1'),
...
def get_single_report_view(request, form_key, report_id):
    try:
        ...
        if form_key in ['deviation-view', 'deviation']:
            ...
            data = {
                "customer": report.customer_account, "part_name": report.part_name, "model_name": report.model_name, "operation": report.operation, "part_number": report.part_number,
