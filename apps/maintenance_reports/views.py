    ...
    def post(self, request):
        try:
            ...
            for row in items:
                ...
                obj = DailyPowerPressChecksheet.objects.create(
                    plant=row.get("plant", ""),
                ...
                print("✅ Daily Power Press saved:", obj.id)
                print("✅ Activity log created:", log.id if log else None)
            ...
            return Response(
                {
                    ...
                    "log_id": (
                        created_logs[0] if len(created_logs) == 1 else created_logs
                    ),
                },
            ...
            print("🔥 Daily Power Press Save Error:", str(e))
            traceback.print_exc()
            return Response(
...
class SaveMachineHistoryCardView(APIView):
    ...
    def post(self, request):
        try:
            ...
            username = (
                data.get("username") or signatures.get("preparedBy") or "Unknown User"
            )

            if not machine_details.get("machineName") or not machine_details.get(
                "machineNo"
            ):
                return Response(
                    {
            ...
            card = MachineHistoryCard.objects.create(
                plant=machine_details.get("plant", ""),
            ...
            print("✅ Machine History Card saved:", card.id)
            print("✅ Activity log created:", log.id if log else None)
            ...
            print("🔥 Machine History Save Error:", str(e))
            traceback.print_exc()
            return Response(
                {
                    "success": False,
...
class SaveMachineBreakdownView(APIView):
    ...
    def post(self, request):
        try:
            ...
            log = auto_log_report(
                username=username,
                report_name="Machine Breakdown Form",
                record_id=intimation.id,
            )

            print("✅ Machine Breakdown Form saved:", intimation.id)
            print("✅ Activity log created:", log.id if log else None)
            ...
            print("🔥 Machine Breakdown Save Error:", str(e))
            traceback.print_exc()
            return Response(
                {"success": False, "error": f"Server Error: {str(e)}"},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    def post(self, request):
        try:
            ...
            for cp in data.get("check_points", []):
                MachineChecksheetObservation.objects.create(
                    report=report,
                    s_no=cp.get("s_no"),
                    poka_yoke_detail=cp.get("poka_yoke_detail", ""),
                    checking_method=cp.get("checking_method", ""),
                    reference_sop=cp.get("reference_sop", ""),
                    is_ok=cp.get("is_ok", False),
            ...
            print("✅ Poka Yoke Checksheet saved:", report.id)
            print("✅ Activity log created:", log.id if log else None)

            return Response(
                {
                    "success": True,
                    "message": "✅ Poka Yoke Checksheet saved successfully.",
                    "id": report.id,
                    "report_id": report.id,
                    "record_id": report.id,
                    "log_id": log.id if log else None,
            ...
            print("🔥 Poka Yoke Save Error:", str(e))
            traceback.print_exc()
            return Response(
                {"success": False, "error": f"Server Error: {str(e)}"},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
class GetTodayPokaYokeDataView(APIView):
    def get(self, request):
        try:
            ...
            if plant_name:
                reports = reports.filter(plant_name=plant_name)
                ...
                data.append(
                    {
                        ...
                        "check_points": [
                            {
                                "s_no": cp.s_no,
                                "poka_yoke_detail": cp.poka_yoke_detail,
                                "checking_method": cp.checking_method,
                                "reference_sop": cp.reference_sop,
                                "is_ok": cp.is_ok,
                                "remarks": cp.remarks or "",
                            }
                            for cp in report.check_points.all()
                        ],
                    }
                )
            ...
            print("🔥 Get Today Poka Yoke Error:", str(e))
            traceback.print_exc()
            return Response(
                {"success": False, "error": f"Server Error: {str(e)}"},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
    ...
    def post(self, request):
        try:
            ...
            mapped_data = {
                ...
                "date": (
                    parse_date(raw_data.get("date")) if raw_data.get("date") else None
                ),
                ...
                "checkpoints": raw_data.get(
                    "tableData", []
                ),  # JSON Field mapped from tableData
                "prepared_by": raw_data.get("preparedBy", ""),
                "checked_by": raw_data.get("checkedBy", ""),
            }
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Spot Welding Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Compressor Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Lathe Machine Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {
                        "success": True,
                        "message": "Vertical Drill Machine Maintenance Saved!",
                    },
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Surface Grinder Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Tig Welding Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Base Grinder Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Belt Grinder Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Pipe Cutting Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Vibra Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Dip Molding Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"success": True, "message": "Servo Press Maintenance Saved!"},
                    status=status.HTTP_201_CREATED,
                )
    ...
    try:
        ...
        if form_key in [
            ...
            data = {
                ...
                "repairHours": report.repair_hours or "",
                "mechanicsCount": report.mechanics_count or "",
                "repairDesc": report.repair_desc or "",
                "status": report.status or "OK",
                "verificationDate": (
                    str(report.verification_date) if report.verification_date else ""
                ),
                "verificationTime": (
                    str(report.verification_time) if report.verification_time else ""
                ),
                "preparedBy": getattr(report, "prepared_by", "") or "",
                "language": getattr(report, "language", "english") or "english",
                "submitted_by": log_entry.username,
                "log_id": log_entry.id,
                "approval_status": log_entry.status,
                "approval_remarks": log_entry.remarks or "",
        ...
        if form_key in ["poka-yoke", "poka_yoke_check", "Poka-Yoke", "pokayoke-view"]:
            ...
            data = {
                ...
                "approved_or_rejected_at": (
                    str(log_entry.approved_or_rejected_at)
