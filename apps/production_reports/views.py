...
from api.serializers import (
    TipChangeDressingSerializer,
    DailyProductionPlanSerializer,
    FourMChangeInspectionSerializer,
    FourMChangeRecordSerializer,
    FourMSummarySerializer,
    FourMInformationSheetSerializer,
)
    ...
    def post(self, request):
        try:
            ...
            return Response(
                {
                    "success": True,
                    "message": "✅ Bin Trolley Data Saved!",
                    "record_id": report.id,
                },
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                # 🔥 AUTO LOG BANAO
                auto_log_report(
                    request.data.get("submitted_by"), "Tip Change Monitor Form", obj.id
                )
                return Response(
                    {
                        "success": True,
...
class CheckFiveSStatusView(APIView):
    def get(self, request):
        try:
            ...
            is_filled = FiveSChecksheetReport.objects.filter(
                date=date, area=area_param
            ).exists()
            ...
            for s_group in checks_data:
                ...
                for pt in s_group.get("points", []):
                    obs_to_create.append(
                        FiveSChecksheetObservation(
                            report=report,
                            s_category=s_category_name,
                            check_point=pt.get("point", ""),
                            status=pt.get("status", "Not Checked"),
                        )
                    )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                # 🔥 AUTO LOG BANAO
                auto_log_report(
                    request.data.get("submitted_by"), "Daily Prod Form", obj.id
                )
                return Response(
                    {
                        "success": True,
                        "message": "Daily Production Plan saved successfully!",
                        "data": serializer.data,
                        "record_id": obj.id,
                    },
                    status=status.HTTP_201_CREATED,
...
def get_today_production_data(request):
    ...
    try:
        ...
        if not plant_name:
            return Response(
                {"success": False, "error": "plant_name is required"}, status=400
            )
        ...
        queryset = DailyProductionPlan.objects.filter(
            plant=plant_name, created_at__date=filter_date
        )
        ...
        return Response(
            {
                "success": True,
                "filled_machines": filled_machines,
...
class UpdateDailyProductionPlanView(APIView):
    def patch(self, request, pk):
        try:
            ...
            serializer = DailyProductionPlanSerializer(
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                # 🔥 AUTO LOG BANAO
                auto_log_report(
                    request.data.get("submitted_by"), "4M Change Inspection", obj.id
                )
                return Response(
                    {
                        "success": True,
                        "message": " 4M Change Inspection data saved successfully!",
                        "data": serializer.data,
                        "record_id": obj.id,
                    },
                    status=status.HTTP_201_CREATED,
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                ...
                # 🔥 AUTO LOG BANAO
                auto_log_report(
                    request.data.get("submitted_by"), "4M Tracking Record", obj.id
                )
                return Response(
                    {
                        "success": True,
                        "message": " 4M Change Record saved successfully!",
                        "data": serializer.data,
                        "record_id": obj.id,
                    },
                    status=status.HTTP_201_CREATED,
            ...
            traceback.print_exc()
            return Response(
                {"success": False, "error": "Server connection failed: " + str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def post(self, request):
        try:
            ...
            return Response(
                {
                    "success": True,
                    "message": " 4M Display Board Saved!",
                    "record_id": last_id,
                },
                status=status.HTTP_201_CREATED,
            )
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {
                        "success": True,
                        "message": "4M Summary Sheet Saved Successfully!",
                        "record_id": last_id,
                    },
                    status=status.HTTP_201_CREATED,
                )
...
class SaveFourMInformationSheetView(APIView):
    ...
    def post(self, request):
        try:
            ...
            # 🔥 AUTO LOG BANAO
            auto_log_report(
                data.get("submitted_by") or prepared_by_val,
                "4M Information Sheet",
                last_id,
            )
            return Response(
                {
    ...
    try:
        ...
        def get_machine_checksheet(r):
            ...
            obs_data = [
                {
                    "s_no": o.s_no,
                    "poka_yoke_detail": o.poka_yoke_detail,
                    "checking_method": o.checking_method,
                    "reference_sop": o.reference_sop,
                    "is_ok": o.is_ok,
                    "remarks": o.remarks,
                }
                for o in obs
            ...
            return {
                ...
                "checked_by_maintenance": r.checked_by_maintenance,
                "verified_by_production": r.verified_by_production,
                "check_points": obs_data,
            }
        ...
        FORM_REGISTRY = {
            ...
            "bin-trolley": lambda r: {
                "date": str(r.date),
                "week": r.week,
                "month": r.month,
                "checkpoints": r.checkpoints,
                "cleaning_details": r.cleaning_details,
                "maintenance_details": r.maintenance_details,
            },
            "rework": lambda r: {
                "date": str(r.date),
                "remark": r.remark,
                ...
                "dynamic_details": r.dynamic_details,
            },
            "rework-view": lambda r: {
                "date": str(r.date),
                "remark": r.remark,
                "part_name": r.part_name,
                "part_no": r.part_no,
            ...
            "monthly-prod-plan": lambda r: {
                "date": str(r.filled_date),
                "partName": r.part_name,
                "customer": r.customer_name,
                "openingStock": r.opening_stock,
                "scheduleQty": r.schedule_qty,
                "plannedQty": r.planned_qty,
                "remark": r.remark,
                "preparedBy": r.prepared_by,
                "approvedBy": r.approved_by,
            },
            "operator-observance-checklist": lambda r: {
                "recordDate": str(r.record_date),
                "operatorName": r.operator_name,
                "model": r.model,
                "partOperation": r.part_operation,
                "formData": r.checkpoints,
                "preparedBy": r.prepared_by,
                "approvedBy": r.approved_by,
            },
            "operator-observance-plan": lambda r: {
                "selectedYear": r.plan_year,
                "selectedMonth": r.plan_month,
                "operators": r.operators_data,
                "preparedBy": r.prepared_by,
                "approvedBy": r.approved_by,
            },
            "pm-checklist-mhe": lambda r: {
                "filledDate": str(r.filled_date),
                "partName": r.part_name,
                "trolleyNo": r.trolley_no,
                "pmFrequency": r.pm_frequency,
                "checkPoints": r.checkpoints,
                "checkedBy": r.checked_by,
                "verifiedBy": r.verified_by,
                "generalRemarks": r.general_remarks,
            },
            "projection-welder": lambda r: {
                "wpsNo": r.wps_no,
                "date": str(r.date),
                "weldingProcess": r.welding_process,
                "baseMetal": r.base_metal,
                "baseMetalThickness": r.base_metal_thickness,
                "machineNo": r.machine_no,
                "trials": r.trials,
                "welderName": r.welder_name,
                "conductedBy": r.conducted_by,
                "verifiedBy": r.verified_by,
                "qualificationStatus": r.qualification_status,
            },
            "spot-welder": lambda r: {
                "wpsNo": r.wps_no,
                "date": str(r.date),
                "weldingProcess": r.welding_process,
                "baseMetal": r.base_metal,
            ...
            "tig-mig-welder": lambda r: {
                "wpsNo": r.wps_no,
                "testingDate": str(r.testing_date),
                "weldingProcess": r.welding_process,
                "machineNo": r.machine_no,
                "baseMetal": r.base_metal,
                "baseMetalThickness": r.base_metal_thickness,
                "baseMetalSize": r.base_metal_size,
                "weldingPosition": r.welding_position,
                "fillerMaterial": r.filler_material,
                "fillerMaterialSize": r.filler_material_size,
                "shieldingGas": r.shielding_gas,
                "wireFeedSpeed": r.wire_feed_speed,
                "trials": r.trials,
            ...
            "process-validation": lambda r: {
                "validationDate": str(r.validation_date),
                "revalidationDate": str(r.revalidation_date),
                ...
                "trials": r.trials,
                "finalParams": r.final_params,
                "conclusion": r.conclusion,
                "preparedBy": r.prepared_by,
                "approvedBy": r.approved_by,
            },
            "four-m-display": lambda r: {
                "s_no": r.s_no,
                "machine_no": r.machine_no,
        ...
        MODEL_REGISTRY = {
            "daily-prod-plan": DailyProductionPlan,
            "four-m-inspection": FourMChangeInspection,
            "four-m-record": FourMChangeRecord,
            "tip-change": TipChangeDressing,
            "four-m-summary": FourMSummary,
            "machine-checksheet": MachineChecksheetReport,
            "five-s": FiveSChecksheetReport,
            "five-s-view": FiveSChecksheetReport,
            "bin-trolley": BinTrolleyReport,
            "rework": ReworkEntry,
            "rework-view": ReworkEntry,
            "monthly-prod-plan": MonthlyProductionPlan,
            "operator-observance-checklist": OperatorObservanceChecklist,
            "operator-observance-plan": OperatorObservancePlan,
            "pm-checklist-mhe": PMChecklistMHE,
            "projection-welder": ProjectionWelderQual,
            "spot-welder": SpotWelderQual,
            "tig-mig-welder": TigMigWelderQual,
            "process-validation": ProcessValidation,
        ...
        if form_key not in FORM_REGISTRY or form_key not in MODEL_REGISTRY:
            return Response(
                {
                    "success": False,
                    "error": f"Form '{form_key}' Not Supported Yet in Production",
                },
                status=400,
            )
        ...
        data["submitted_by"] = (
            submitted_user  # Original email bhi rakh lete hain backup ke liye
        )
...
def production_data_view(request, form_key):
    ...
    if form_key == "daily-prod-plan":
        try:
            ...
            records = apply_date_filter(base_query, "plan_date").order_by(
            ...
            data = [
                {
                    ...
                    "Start Time": (
                        str(r.production_start_time) if r.production_start_time else "—"
                    ),
                    "End Time": (
                        str(r.production_end_time) if r.production_end_time else "—"
                    ),
                    "Total Time": r.total_working_time or "—",
                    "Tool Setup (min)": (
                        r.tool_setup_time if r.tool_setup_time is not None else 0
                    ),
                    "Machine B/D (min)": (
                        r.machine_bd_time if r.machine_bd_time is not None else 0
                    ),
                    "Tool B/D (min)": (
                        r.tool_bd_time if r.tool_bd_time is not None else 0
                    ),
    ...
    # ── 2. 4M CHANGE INSPECTION REPORT ──────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "inspection_date").order_by(
    ...
    # ── 3. 4M CHANGE RECORD ─────────────────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "created_at").order_by(
                "-created_at"
            )
            data = []
            ...
            for r in records:
                ...
                parameters_list = [
                    ...
                    (
                        "Approval & Training",
                        "Training Provided",
                        getattr(r, "training_provided", "") or "",
                    ),
                    (
                        "Retroactive",
                        "Qty Checked",
                        (
                            getattr(r, "retro_qty_checked", "")
                            if getattr(r, "retro_qty_checked", None) is not None
                            else ""
                        ),
                    ),
                    ...
                    (
                        ...
                        "Qty Checked",
                        (
                            getattr(r, "cont_qty_checked", "")
                            if getattr(r, "cont_qty_checked", None) is not None
                            else ""
                        ),
                    ),
                    ...
                    (
                        ...
                        (
                            str(r.dispatch_date)
                            if getattr(r, "dispatch_date", None)
                            else ""
                        ),
                    ),
    ...
    # ── 5. BIN TROLLEY REPORT ───────────────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "date").order_by(
                "-date", "-created_at"
            )
            data = []
            for r in records:
                ...
                items_list = [
                    (
                        "Checkpoints",
                        "1. Bin/Trolley Should Be Clean Properly",
                        cp.get("cp1", {}).get("status", ""),
                        cp.get("cp1", {}).get("remarks", ""),
                    ),
                    (
                        "Checkpoints",
                        "2. Bin/Trolley Should be Free From Dust",
                        cp.get("cp2", {}).get("status", ""),
                        cp.get("cp2", {}).get("remarks", ""),
                    ),
                    (
                        "Checkpoints",
                        "3. Bin/Trolley Should Not Be Damage And Broken",
                        cp.get("cp3", {}).get("status", ""),
                        cp.get("cp3", {}).get("remarks", ""),
                    ),
                    (
                        "Checkpoints",
                        "4. Bin/Trolley Should be Free From Oil Surface",
                        cp.get("cp4", {}).get("status", ""),
                        cp.get("cp4", {}).get("remarks", ""),
                    ),
                    (
                        "Checkpoints",
                        "5. Bin/Trolley Should Be Clean In Bin Cleaning Area",
                        cp.get("cp5", {}).get("status", ""),
                        cp.get("cp5", {}).get("remarks", ""),
                    ),
                    (
                        "Checkpoints",
                        "6. Others (Please Specify)",
                        cp.get("cp6", {}).get("status", ""),
                        cp.get("cp6", {}).get("remarks", ""),
                    ),
                    (
                        "Cleaning Details",
                        "Total Bin / Trolley Quantity",
                        cl.get("cd1", {}).get("frequency", ""),
                        cl.get("cd1", {}).get("remarks", ""),
                    ),
                    (
                        "Cleaning Details",
                        "Bin / Trolley Clean Quantity",
                        cl.get("cd2", {}).get("frequency", ""),
                        cl.get("cd2", {}).get("remarks", ""),
                    ),
                    (
                        "Cleaning Details",
                        "Bin / Trolley Unclean Quantity",
                        cl.get("cd3", {}).get("frequency", ""),
                        cl.get("cd3", {}).get("remarks", ""),
                    ),
                    (
                        "Maintenance Details",
                        "Total Maintenance Quantity",
                        mn.get("md1", {}).get("frequency", ""),
                        mn.get("md1", {}).get("remarks", ""),
                    ),
                    (
                        "Maintenance Details",
                        "Bin/Trolley Ok Quantity",
                        mn.get("md2", {}).get("frequency", ""),
                        mn.get("md2", {}).get("remarks", ""),
                    ),
                    (
                        "Maintenance Details",
                        "Bin/Trolley Reject Quantity",
                        mn.get("md3", {}).get("frequency", ""),
                        mn.get("md3", {}).get("remarks", ""),
                    ),
                ]
                        ...
                        data.append(
                            {
                                ...
                                "Prepared By": log_mapping.get(report.id, {}).get(
                                    "prepared_by", "—"
                                ),
                                "Approved By": log_mapping.get(report.id, {}).get(
                                    "approved_by", "—"
                                ),
                            }
                        )
    ...
    # ── 7. MONTHLY PRODUCTION PLAN ──────────────────────────────
        ...
        try:
            ...
            reports = apply_date_filter(base_query, "created_at").order_by(
                "-created_at"
            )
            data = []
            for r in reports:
                data.append(
                    {
                        ...
                        "Remark": r.remark or "",
                        "Prepared By": log_mapping.get(r.id, {}).get(
                            "prepared_by", "—"
                        ),
                        "Approved By": log_mapping.get(r.id, {}).get(
                            "approved_by", "—"
                        ),
                    }
                )
    ...
    # ── 8. OPERATOR OBSERVANCE CHECKLIST ────────────────────────
        ...
        try:
            ...
            reports = apply_date_filter(base_query, "record_date").order_by(
                "-created_at"
            )
            data = []
            ...
            for r in reports:
                ...
                if not checkpoints:
                    ...
                    for cp in checkpoints:
                        ...
                        row["Effectiveness"] = effect_map.get(
                            raw_effect, cp.get("effect", "")
                        )
    ...
    # ── 10. PM CHECKLIST MHE ─────────────────────────────────────
        ...
        try:
            ...
            reports = apply_date_filter(base_query, "filled_date").order_by(
                "-created_at"
            )
            data = []
            for r in reports:
    ...
    # ── 13. TIG/MIG WELDER QUALIFICATION ──────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "testing_date").order_by(
                "-created_at"
            )
            data = []
            for r in records:
    ...
    # ── 14. PROCESS VALIDATION REPORT ─────────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "validation_date").order_by(
                "-created_at"
            )
            data = []
            for r in records:
                ...
                if isinstance(ops, str):
                    try:
                        ...
                        ops = []
                operators_str = (
                    ", ".join([op for op in ops if op]) if isinstance(ops, list) else ""
                )

                common_data = {
                    "Validation Date": (
                        str(r.validation_date) if r.validation_date else ""
                    ),
    ...
    # ── 15. 4M DISPLAY BOARD ──────────────────────────────────────
        ...
        try:
            ...
            records = apply_date_filter(base_query, "date_filled").order_by(
                "-created_at"
            )
            data = [
                {
            ...
            data = [
                {
                    ...
                    "Retro Total Qty": (
                        r.retro_total_qty if r.retro_total_qty is not None else ""
                    ),
                    "Retro OK Qty": (
                        r.retro_ok_qty if r.retro_ok_qty is not None else ""
                    ),
                    "Retro Rej. Qty": (
                        r.retro_rej_qty if r.retro_rej_qty is not None else ""
                    ),
    ...
    return JsonResponse(
        {"data": [], "error": "Production form type not supported"}, status=400
    )
...
class SaveMonthlyProdPlanView(APIView):
    ...
    def post(self, request):
        try:
            ...
            username = data.get("username") or data.get("preparedBy") or "Unknown User"

            department_name_for_notification = "Production"
            ...
            department_name_for_table = f"{plant_name} (Production)"
            ...
            if not log:
                raise Exception(
                    "Monthly Production Plan saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Monthly Production Plan Data Saved!",
                    "record_id": plan.id,
                    "log_id": log.id,
                    "report_name": "Monthly Prod Plan",
...
class SaveOperatorObservanceChecklistView(APIView):
    ...
    def post(self, request):
        try:
            ...
            log = auto_log_report(
                username=username,
                report_name="Operator Observance Checklist",
            ...
            if not log:
                raise Exception(
                    "Operator Observance Checklist saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Operator Observance Checklist Saved!",
                    "record_id": checklist.id,
                    "log_id": log.id,
                    "report_name": "Operator Observance Checklist",
                    "department_name": department_name_for_table,
...
class SaveOperatorObservancePlanView(APIView):
    ...
    def post(self, request):
        try:
            ...
            log = auto_log_report(
                username=username,
                report_name="Operator Observance Plan",
                record_id=plan.id,
                department_name=department_name_for_notification,
                target_group="Production_Approvers",
            )
            ...
            if not log:
                raise Exception(
                    "Operator Observance Plan saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Operator Observance Plan Saved!",
                    "record_id": plan.id,
                    "log_id": log.id,
                    "report_name": "Operator Observance Plan",
                    "department_name": department_name_for_table,
...
class SavePMChecklistMHEView(APIView):
    ...
    def post(self, request):
        try:
            ...
            username = data.get("username") or data.get("checkedBy") or "Unknown User"
            ...
            log = auto_log_report(
                username=username,
                report_name="PM Checklist MHE",
                record_id=pm_form.id,
                department_name=department_name_for_notification,
                target_group="Production_Approvers",
            )
            ...
            if not log:
                raise Exception(
                    "PM Checklist MHE saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Preventive Maintenance MHE Data Saved!",
                    "record_id": pm_form.id,
                    "log_id": log.id,
                    "report_name": "PM Checklist MHE",
                    "department_name": department_name_for_table,
...
class SaveProjectionWelderView(APIView):
    ...
    def post(self, request):
        try:
            ...
            username = data.get("username") or data.get("conductedBy") or "Unknown User"
            ...
            if not log:
                raise Exception(
                    "Projection Welder saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Projection Welder Data Saved!",
                    "record_id": welder.id,
                    "log_id": log.id,
                    "report_name": "Projection Welder",
                    "department_name": department_name_for_table,
            ...
            print(f"Projection Welder Error: {str(e)}")
            traceback.print_exc()
            return Response(
                {"success": False, "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
class SaveSpotWelderView(APIView):
    ...
    def post(self, request):
        try:
            ...
            if not log:
                raise Exception(
                    "Spot Welder saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Spot Welder Data Saved!",
                    "record_id": welder.id,
                    "log_id": log.id,
                    "report_name": "Spot Welder",
                    "department_name": department_name_for_table,
            ...
            print(f"Spot Welder Error: {str(e)}")
            traceback.print_exc()
            return Response(
                {"success": False, "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
class SaveTigMigWelderView(APIView):
    ...
    def post(self, request):
        try:
            ...
            test_results = {
                "visual_test": data.get("visualTest", ""),
                "defect": data.get("defectSelect", ""),
                "strength_test": data.get("strengthTest", ""),
                "root_bend": data.get("rootBend", ""),
                "face_bend": data.get("faceBend", ""),
            }
            ...
            if not log:
                raise Exception(
                    "TIG/MIG Welder saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "MIG/TIG Welder Data Saved!",
                    "record_id": welder.id,
                    "log_id": log.id,
                    "report_name": "TIG/MIG Welder",
                    "department_name": department_name_for_table,
            ...
            print(f"TIG/MIG Welder Error: {str(e)}")
            traceback.print_exc()
            return Response(
                {"success": False, "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
class SaveProcessValidationView(APIView):
    ...
    def post(self, request):
        try:
            ...
            log = auto_log_report(
                username=username,
                report_name="Process Validation",
            ...
            if not log:
                raise Exception(
                    "Process Validation saved, but activity log/notification failed."
                )
            ...
            return Response(
                {
                    "success": True,
                    "message": "Process Validation Data Saved!",
                    "record_id": validation.id,
                    "log_id": log.id,
                    "report_name": "Process Validation",
                    "department_name": department_name_for_table,
            ...
            print(f"Process Validation Error: {str(e)}")
            traceback.print_exc()
            return Response(
                {"success": False, "error": str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
